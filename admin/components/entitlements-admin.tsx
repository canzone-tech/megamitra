  ...
  return (
    <div className="mm-admin-shell">
      <header className="mm-topbar">
        <div className="mm-brand"><span className="mm-brand-mark">M</span><div><div>Mega<span className="mm-brand-accent">GoldenClub</span></div><div className="mm-brand-subtitle">Products & entitlements</div></div></div>
      ...
      <main className="mm-page">
        <div className="mm-hero-row"><div><p className="mm-eyebrow">Product benefits</p><h1 className="mm-title">Products & benefits</h1><p className="mm-subtitle">Manage products, eligibility rules, member claims and fulfillment from one workspace.</p></div><button className="mm-button" type="button" disabled={loading || busy} onClick={() => void load()}>{loading ? 'Refreshing…' : 'Refresh'}</button></div>
