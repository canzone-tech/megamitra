  ...
  return (
    <div className="mm-admin-shell">
      <header className="mm-topbar">
        <div className="mm-brand"><span className="mm-brand-mark">M</span><div><div>Mega<span className="mm-brand-accent">GoldenClub</span></div><div className="mm-brand-subtitle">Business plan configuration</div></div></div>
      ...
      <main className="mm-page">
        <div className="mm-hero-row">
          <div><p className="mm-eyebrow">Business plan setup</p><h1 className="mm-title">Business plan control</h1><p className="mm-subtitle">Manage program, binary, referral, automation and lucky draw rules from one place. Review changes as drafts before publishing them.</p></div>
