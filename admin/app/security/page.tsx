    ...
    <div className="mm-admin-shell">
      ...
      <main className="mm-page">
        <div className="mm-hero-row">
          <div><p className="mm-eyebrow">Account security</p><h1 className="mm-title">Verified email change</h1><p className="mm-subtitle">Changing the admin account email requires the current password plus confirmation from the new address. A successful change revokes all existing sessions.</p></div>
        </div>
