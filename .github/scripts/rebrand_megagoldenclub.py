...
replacements = [
    ('MegaGoldenClub', 'MegaGoldenClub'),
    ('MEGAGOLDENCLUB', 'MEGAGOLDENCLUB'),
    ('@megagoldenclub/design-tokens', '@megagoldenclub/design-tokens'),
    ('megagoldenclub-backend', 'megagoldenclub-backend'),
    ('megagoldenclub-admin', 'megagoldenclub-admin'),
    ('megagoldenclub-web', 'megagoldenclub-web'),
    ('megagoldenclub-member', 'megagoldenclub-member'),
    ('megagoldenclub_admin_access', 'megagoldenclub_admin_access'),
    ('megagoldenclub_admin_refresh', 'megagoldenclub_admin_refresh'),
    ('megagoldenclub_member_access', 'megagoldenclub_member_access'),
    ('megagoldenclub_member_refresh', 'megagoldenclub_member_refresh'),
    ('megagoldenclub-api', 'megagoldenclub-api'),
    ('megagoldenclub-clients', 'megagoldenclub-clients'),
    ('megagoldenclub:', 'megagoldenclub:'),
    ('megagoldenclub.local', 'megagoldenclub.local'),
    ('megagoldenclub-uat-headers', 'megagoldenclub-uat-headers'),
    ('megagoldenclub-uat-body', 'megagoldenclub-uat-body'),
    ('megagoldenclub-${randomUUID()}', 'megagoldenclub-${randomUUID()}'),
]
