      ...
      <main className="mm-public-main">
        <section className="mm-public-hero">
          <div>
            ...
            <p>
              MegaGoldenClub brings program participation, payments, qualification, referrals, lucky draws and prize fulfillment into one auditable member experience. Your dashboard shows facts recorded by the platform—not promotional estimates.
            </p>
        ...
        <section className="mm-section" id="how-it-works">
          ...
          <p className="mm-section-lead">MegaGoldenClub keeps participation, reward calculation, draw selection and fulfillment as separate auditable stages. Your portal reads those authoritative records without creating hidden business rules.</p>
