  ...
  return (
    <div className="mm-member-shell">
      <header className="mm-site-header">
        ...
        <nav className="mm-nav"><Link className="mm-button light" href="/member/kyc">KYC</Link><Link className="mm-button light" href="/member/security">Security</Link><Link className="mm-button light" href="/">Public site</Link><button className="mm-button" type="button" onClick={() => void logout()}>Sign out</button></nav>
      </header>
